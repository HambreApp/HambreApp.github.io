...
imgArray.push(new Restaurants("Priya", "PriyaIndian.jpg", 2, "https://www.yelp.com/biz/priya-chico?osq=indian", "Indian", false));
imgArray.push(new Restaurants("Franky\'s", "Frankys.jpg", 2, "https://www.yelp.com/biz/frankys-chico?osq=italian", "Italian", false));
imgArray.push(new Restaurants("Pelican\'s Roost and Chowder", "PelicansRoost.jpg", 2, "https://www.yelp.com/biz/pelicans-roost-and-chowder-house-chico?osq=seafood", "Seafood", false));
imgArray.push(new Restaurants("Pueblito Mexican Grill", "PueblitoMexican.jpg", 2, "https://www.yelp.com/biz/pueblito-mexican-grill-durham", "Mexican", false));
imgArray.push(new Restaurants("Lucky Poke", "LuckyPoke.jpg", 2, "https://www.yelp.com/biz/lucky-poke-chico-2?osq=poke", "Japanese", false));
imgArray.push(new Restaurants("Morning Thunder Cafe", "MorningThunderCafe.jpg", 2, "https://www.yelp.com/biz/morning-thunder-cafe-chico?osq=morning+thunder+cafe", "American", false));
imgArray.push(new Restaurants("Aonami Sushi Bar", "Aonami.jpg", 2, "https://www.yelp.com/biz/aonami-chico", "Japanese", false));
imgArray.push(new Restaurants("Celestino\'s Pizza", "CelestinosPizza.jpg", 1, "https://www.yelp.com/biz/celestinos-new-york-pizza-chico-2", "Italian", false));
imgArray.push(new Restaurants("Kinder\'s", "Kinders.jpg", 2, "https://www.yelp.com/biz/kinders-meats-deli-bbq-chico", "American", false));
imgArray.push(new Restaurants("I Fish Poke Bar Thai Kitchen", "IFishPokeBarThaiKitchen.jpg", 2, "https://www.yelp.com/biz/i-fish-poke-bar-thai-kitchen-chico-4", "Japanese", false));
imgArray.push(new Restaurants("Happy Garden Restaurant", "HappyGarden.jpg", 1, "https://www.yelp.com/biz/happy-garden-restaurant-chico", "Chinese", false));
imgArray.push(new Restaurants("Mekkala Thai Cuisine", "MekkalaThai.jpg", 2, "https://www.yelp.com/biz/mekkala-thai-cuisine-chico?osq=thai", "Oriental", false));
imgArray.push(new Restaurants("El Guayacan", "ElGuayacan.jpg", 2, "https://www.yelp.com/biz/el-guayacan-mexican-restaurant-chico?osq=mexican", "Mexican", false));
...
function counters(){
  ...
  if(imgArray[i].typeofr == "American"){
    ...
    if(american >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you American food! Here is a list of American restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
        if(imgArray[j].typeofr == "American"){
          if(imgArray[j].chosen == true){
            document.getElementById("replace" + counter).innerHTML = "<a class=\"sitelinks\" href=\"" + imgArray[j].link + "\"> " + imgArray[j].name + "</a>" + "<p> The price of " + imgArray[j].name + " is " + imgArray[j].cost + " out of 4.</p>"
            counter = counter + 1;
          }
        }
      }
    ...
    if(mexican >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Mexican food! Here is a list of Mexican restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br><br>";
    ...
    if(italian >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Italian food! Here is a list of Italian restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(japanese >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Japanese food! Here is a list of Japanese restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(chinese >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Chinese food! Here is a list of Chinese restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(indian >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Indian food! Here is a list of Indian restuarants in the Chico area! </p><br><p> Please click on the links below to learn more information about the restaurants!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(oriental >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Oriental food! Here is a list of Oriental restuarants in the Chico area!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(seafood >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Seafood! Here is a list of Seafood restuarants in the Chico area!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
    ...
    if(mediterranean >= 3){
      document.getElementById("replace").innerHTML = "<p>Your choices have given you Mediterranean food! Here is a list of Mediterranean restuarants in the Chico area!</p><br>";
      window.scrollBy(0, 500)
      for(var j=0; j<imgArray.length; j++){
